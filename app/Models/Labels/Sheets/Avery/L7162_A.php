...
class L7162_A extends L7162
{
    ...
    private const LABEL_SIZE     =   3.20;
    private const LABEL_MARGIN   = - 0.50;
    private const FIELD_SIZE     =   3.60;
    ...
    public function getSupportFields()    { return 16; }
    ...
    public function write($pdf, $record) {
        ...
        if ($record->has('title')) {
            ...
            $currentY2 += self::TITLE_SIZE + self::TITLE_MARGIN;
        }
	   ...
	   //  dump($field);
            ...
            $currentY2 += self::LABEL_SIZE + self::LABEL_MARGIN;
            ...
            static::writeText(
                ...
                $usableWidth, self::FIELD_SIZE, false, 0, 0.3
            );
            $currentY += self::FIELD_SIZE + self::FIELD_MARGIN;
            $currentY2 += self::FIELD_SIZE + self::FIELD_MARGIN;
        }

        if ($record->has('barcode2d')) {
            static::writeText(
                $pdf, $record->get('tag'),
                $currentX, $currentY2 - self::TAG_SIZE,
